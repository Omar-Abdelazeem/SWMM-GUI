...
begin
  ...
  aNode.Data[JUNCTION_CONSUMPTION_PATTERN]  := TokList[9];
  aNode.Data[JUNCTION_LEAKAGE_COEFFICIENT_INDEX]  := TokList[10];
  aNode.Data[JUNCTION_LEAKAGE_EXPONENT_INDEX]  := TokList[11];
  Result := 0;
end;
